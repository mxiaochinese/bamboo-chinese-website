...
function finder() {
  return `<div class="finder" data-finder><div class="finder-panel"><div class="finder-progress" aria-hidden="true"><span class="progress-dot active" data-progress="1"></span><span class="progress-dot" data-progress="2"></span></div><p class="finder-question" data-finder-question>Con đã từng học tiếng Trung chưa?</p><div class="choice-grid" data-finder-choices></div><div class="finder-result" data-finder-result aria-live="polite"></div></div><div class="finder-story"><figure class="finder-scene"><img src="/assets/brand/classroom-learning-v1.png" alt="Giáo viên và trẻ cùng học trong lớp nhỏ" loading="lazy"><figcaption><strong>Đồng hành cùng con</strong><span>Từ cấp độ phù hợp đến từng bước tiến bộ</span></figcaption></figure><div class="finder-steps"><div class="mini-step"><span class="mini-step-number">01</span><div><h3>Hiểu điểm bắt đầu</h3><p>Gia đình cho biết con đã từng học tiếng Trung chưa.</p></div></div><div class="mini-step"><span class="mini-step-number">02</span><div><h3>Chọn cấp độ gần nhất</h3><p>Nếu con đã từng học, hãy chọn cấp độ gần nhất mà gia đình còn nhớ.</p></div></div><div class="mini-step"><span class="mini-step-number">03</span><div><h3>Chọn lớp phù hợp</h3><p>Bamboo dựa trên độ tuổi và nền tảng hiện tại để tư vấn lớp học phù hợp cho con.</p></div></div></div></div></div>`;
}
